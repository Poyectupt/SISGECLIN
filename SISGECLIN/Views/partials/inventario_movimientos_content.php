...
<div class="table-container">
    <div class="table-header">
        ...
        <div style="display: flex; gap: 12px; align-items: center;">
            <select onchange="window.location.href='index.php?module=inventario_movimientos&periodo=' + this.value" style="padding: 8px 12px; border-radius: 8px; border: 2px solid var(--grey);">
            ...
            <select onchange="window.location.href='index.php?module=inventario_movimientos&tipo=' + this.value" style="padding: 8px 12px; border-radius: 8px; border: 2px solid var(--grey);">
                <option value="">Todos los Tipos</option>
                <option value="entrada" <?php echo $tipo_filtro === 'entrada' ? 'selected' : ''; ?>>Solo Entradas</option>
                <option value="salida" <?php echo $tipo_filtro === 'salida' ? 'selected' : ''; ?>>Solo Salidas</option>
            </select>
        </div>
    </div>
